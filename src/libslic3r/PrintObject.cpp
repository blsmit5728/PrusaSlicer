...
std::unique_ptr<FillAdaptive_Internal::Octree> PrintObject::prepare_adaptive_infill_data()
{
    ...
    return FillAdaptive::build_octree_for_adaptive_support(mesh, line_spacing, rotation_matrix * mesh_origin, rotation_matrix);
#else
    return FillAdaptive::build_octree(mesh, line_spacing, rotation_matrix * mesh_origin);
#endif
}
